...
public class ControllerMapping {
     ...
     */
    public void mapEvent(String eventName, GamepadInput input, boolean override) {
        if (override) {
    ...
    public void mapEvent(String eventName, GamepadInput input) {
        mapEvent(eventName, input, false);
    }
