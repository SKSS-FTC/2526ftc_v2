...
public class MoveIntakeDownSubmersible extends CommandBase {

    private VerticalIntakeSubsystem intake;
    private Timing.Timer timer;

    public MoveIntakeDownSubmersible(VerticalIntakeSubsystem intake){
        this.intake = intake;
    ...
    public void initialize(){
        ...
        intake.moveIntakeDownSubmersible();
        timer.start();
    }
    ...
    public MoveIntakeDownSubmersible copy(){
        return new MoveIntakeDownSubmersible(intake);
    }
