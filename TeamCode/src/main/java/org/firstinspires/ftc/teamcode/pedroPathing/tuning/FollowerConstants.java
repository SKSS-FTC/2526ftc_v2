...
public class FollowerConstants {
    ...
    private static double xMovement = 65.8579357;
    private static double yMovement = 53.2778685936;//53.12933491425573,/54.30590523218858,52.73295731071149,52.943276917424065
    ...
    public static double mass = 11.17;

    // Centripetal force to power scaling
    public static double centripetalScaling = 0.00045;


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = -32.3150621178;//-32.299867986338135,-32.77351908397488,-31.85466273347275

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration =-49.9409828455;// -49.79988431611487,-41.5510511459521
