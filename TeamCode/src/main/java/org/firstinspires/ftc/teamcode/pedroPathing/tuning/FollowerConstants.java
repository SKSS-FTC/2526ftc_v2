...
public class FollowerConstants {
    ...
    private static double xMovement = 70.49;//58.98;
    private static double yMovement = 51.46;//43.57;
    ...
    public static double mass = RobotConfig.DriveConstants.compBotMass;
    ...
    public static double forwardZeroPowerAcceleration = -25.217;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -63.3176;
