...
@Autonomous(name = "Auto Leave Launch Line")
public class DecodeLM1Auto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (counter < 2) {
            frontLeftMotor.setPower(ConstantsAuto.DRIVE_SPEED);
            backLeftMotor.setPower(ConstantsAuto.DRIVE_SPEED);
            frontRightMotor.setPower(ConstantsAuto.DRIVE_SPEED);
            backRightMotor.setPower(ConstantsAuto.DRIVE_SPEED);
        }
