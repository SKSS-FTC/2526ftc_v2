...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.0029523056762454977;//0.029548647483963207;
    public static double STRAFE_TICKS_TO_INCHES =0.0029954257732032765;// 0.0028838990080938868;
    public static double TURN_TICKS_TO_RADIANS =0.002963999673;///0.003;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        leftEncoderPose = new Pose(0,-16/2.54, 0);
        rightEncoderPose = new Pose( 0,16/2.54, 0);
        strafeEncoderPose = new Pose( -15/2.54,3/2.54, Math.toRadians(90));
