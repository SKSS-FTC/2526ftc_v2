 ...
 */
@Config
@TeleOp(group = "Pedro Pathing Tuning", name = "Auto Pose Finder")
public class StartPosLocalizationTest extends OpMode {
    ...
    public void init() {
        ...
        poseUpdater.setPose(RobotConfig.AutoPoseStorage.startPose);
